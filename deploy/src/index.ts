...
const deployBitcoinSPV = async (
    ...
    const initMsg = {
        ...require('./init_msg/bitcoin_spv.json')[bitcoinNetwork],
    };
...
const deploySFPS = async (
    ...
    const initMsg = {
        ...require('./init_msg/sfps.json')[deployer.snNetwork],
...
const deployGateway = async (
    ...
    const initMsg = {
        ...
        config: {
            ...
            log: log,
            ...require('./init_msg/gateway.json')[bitcoinNetwork].config,
        },
    };
...
const main = async () => {
    ...
    const bitcoinSPV = await deployBitcoinSPV(deployer, config.bitcoinNetwork);
