...
describe('TendermintMerkleTree', () => {
    describe('TxDataEncoder', () => {
        describe('encode', () => {
            it('should encode tx result correctly', async () => {
                const tx_result = {
                    code: 0,
                ...
                const encoded = encoder.encode(tx_result);
                assert.equal(
        ...
        describe('decode', () => {
            it('should decode to tx result correctly', async () => {
                const encoder = await TxDataEncoder.init();
                ...
                assert.equal(
                    ...
                    '{"data":"","gasWanted":"50000","gasUsed":"23757"}'
                );
            });
        });
        describe('from json', () => {
            it('deserialize json correctly', async () => {
                const json =
